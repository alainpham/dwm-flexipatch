...
static char titlenormbordercolor[]       = "#555753";
...
static char tagsnormbordercolor[]        = "#555753";
...
static const Key keys[] = {
	...
	{ Mod1Mask,                     XK_KP_4        spawn,                  SHCMD("pactl set-sink-mute from-desktop toggle; kill -44 $(pidof dwmblocks)")},
	{ Mod1Mask,                     XK_KP_5        spawn,                  SHCMD("pactl set-sink-mute from-caller toggle; kill -44 $(pidof dwmblocks)")},
	#if RIODRAW_PATCH
